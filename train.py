...
if __name__ == '__main__':
    ...
    parser.add_argument('-qmargin', action='store_true', default=False, help='use qmargin selection')
    parser.add_argument('-b', type=int, default=128, help='batch size for dataloader')
    parser.add_argument('-warm', type=int, default=-1, help='warm up training phase')
    parser.add_argument('-lr', type=float, default=0.05, help='initial learning rate')
    parser.add_argument('-q', '--quantile', type=float, default=1.0, help='quantile to evaluate margin selection with')
    parser.add_argument('-m', '--margin', type=float, default=0.4, help='selection margin')
    ...
    writer = SummaryWriter(log_dir=os.path.join(
            settings.LOG_DIR, args.net, 'qmargin' if args.qmargin else 'standard', settings.TIME_NOW))
